...
type StatsRepository interface {
	...
	TimeClassStats(ctx context.Context, profileID int64) ([]models.TimeClassStat, error)
	ColorStats(ctx context.Context, profileID int64) ([]models.ColorStat, error)
	MonthlyStats(ctx context.Context, profileID int64) ([]models.MonthlyStat, error)
	MistakePhaseStats(ctx context.Context, profileID int64) ([]models.MistakePhaseStat, error)
	RatingStats(ctx context.Context, profileID int64) ([]models.RatingStat, error)
